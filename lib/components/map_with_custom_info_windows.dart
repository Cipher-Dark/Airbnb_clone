...
class _MapWithCustomInfoWindowsState extends State<MapWithCustomInfoWindows> {
  LatLng myCurrentLocation = const LatLng(29.995199, 78.722198);
  ...
  Future<void> _loadMarkers() async {
    var customIcon = await BitmapDescriptor.asset(ImageConfiguration(), "asset/images/marker.png", height: 40, width: 30);
                              ...
                              SizedBox(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: AnotherCarousel(
                                    images: data['imageUrls'].map((url) => NetworkImage(url)).toList(),
                                    dotSize: 5,
