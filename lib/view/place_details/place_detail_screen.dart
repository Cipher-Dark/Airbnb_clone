...
import 'package:airbnb/components/start_rating.dart';
        ...
        children: [
          Column(
            children: [
              ...
              StartRating(rating: widget.place['rating']),
            ],
          ),
          Stack(
            children: [
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: MyIconButton(
                    ...
                    iconColor: provider.isExist(widget.place) ? Colors.red : Colors.black54,
                  ),
                )
              ],
            ),
